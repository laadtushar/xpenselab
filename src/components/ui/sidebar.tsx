  ...
  (
    ...
    return (
      ...
      >
        <div
            data-sidebar="sidebar"
            className={cn("flex h-full w-full flex-col bg-sidebar transition-all duration-300",
            variant === 'floating' || variant === 'inset' ? 'rounded-lg border border-sidebar-border shadow' : side ==='left' ? 'border-r' : 'border-l')}
          >
            {children}
          </div>
      </aside>
