...
interface IncomeFormFromSaltEdgeProps {
  transaction: SaltEdgeTransaction;
}

export function IncomeFormFromSaltEdge({ transaction }: IncomeFormFromSaltEdgeProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" size="sm">
          <ArrowUpRight className="mr-2 h-4 w-4"/> Import Income
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Import Bank Income</DialogTitle>
        </DialogHeader>
        <Form {...form}>
